# Original source: https://github.com/openmoneymarket/openmoneymarket-mono/tree/development/scripts/prep-icx-delegations
...
def get_prep_delegation_info(prep_address):
    ...
    return instance.get_delegation_info()
